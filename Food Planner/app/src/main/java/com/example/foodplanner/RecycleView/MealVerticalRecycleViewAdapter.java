...
public class MealVerticalRecycleViewAdapter extends RecyclerView.Adapter<MealRecycleViewHolder> {
    private Context context;
    private List<MealDTO> meals;
    private OnFavListener listener;
    private boolean remote;

    public MealVerticalRecycleViewAdapter(Context _context, List<MealDTO> _meals, OnFavListener _listener, boolean _remote){
        context = _context;
        meals = _meals;
        listener =_listener;
        remote = _remote;
